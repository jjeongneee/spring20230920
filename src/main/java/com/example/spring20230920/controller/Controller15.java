...
public class Controller15 {
    ...
    //  @GetMapping 은 안됨! null 값으로 들어가서 sub4 값이 전송이 안됨
    @PostMapping("sub5")
...
//    sub8.jsp 로 포워드하는 메소드 만들기
    ...
    // 내 방식
//    @PostMapping("sub8")
//    public void method8(@RequestParam(name = "foods", required = false) String[] foods, HttpSession session) {
//       if (foods != null) {
//           System.out.println("foods = " + foods.toString());
//           session.setAttribute("userchoice", Arrays.asList(foods));
//       }
//    }
