...
<form>
    <%--
       전송버튼 클릭시
       ?name=les&age=44&address=seoul&email=abc@gamil.com
       --%>
...
<%--전송버튼 클릭시 request patameter가 /main12/sub2 로 전송되도록--%>
...
<hr>
<h1>action 속성 값 : /도 아니고 protocol(scheme)이 아니면 현재페이지의 상대 경로</h1>
