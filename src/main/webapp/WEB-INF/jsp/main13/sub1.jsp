...
<%--  pattern="\d{3}"  3개 값만 입력 가능--%>
    <div>
        <input type="text" pattern="\d{3}" name="param5">
    </div>
<%--    div*2>input:c--%>
<%--    div*2>input:c[name=param$]--%>
    <div>
...
<%--    div>div*3>label[for=check$]>lorem1^input:c#check$--%>
    <div>
        ...
        <div>
            <label for="check2">Dolorem.</label>
            <input type="checkbox" name="" id="check2">
        </div>
        <div>
            <label for="check3">Ratione!</label>
            <input type="checkbox" name="" id="check3">
        </div>
    </div>
<%--    input 은 closing code 가 없다--%>
