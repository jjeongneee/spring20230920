...
-- 예) my_table6 만들기
-- age 컬럼 정수 타입
-- score 컬럼 총길이 7 소숫점 이하 길이 2

CREATE TABLE my_table_6 (
    age INT,
    score DEC(7, 2)
);
INSERT INTO my_table_6(age, score)
VALUE (300, 2342.33);
INSERT INTO my_table_6(age, score)
VALUE (300, 2342.334);
SELECT * FROM my_table_6;
...
VALUE ('정국', '서울 이태원', '01000000000');

INSERT INTO my_table9(name, address, phone_number)
VALUE ('은우', '서울 어딘가', '100000000');
